...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'bf', isPlayer:Bool = false)
	{
		...
		animation.add('majin', [28, 29], 0, false, isPlayer);
		...
		animation.add('aceFIGHT', [24, 25], 0, false, isPlayer);
		animation.add('aceGOD', [24, 25], 0, false, isPlayer);
		...
		animation.add('luna-duo', [49, 49], 0, false, isPlayer);
